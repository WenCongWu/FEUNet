"""
Training a FEUNet model for color image denoising.
"""
import os
import argparse
import numpy as np
...
def main(args):
	...
	if not args.gray:
		...
		in_ch = 1
	net = FEUNet(num_input_channels=in_ch)
	...
	for epoch in range(start_epoch, args.epochs):
		...
		logger.info('\t[epoch %d] PSNR_val: %.4f' % (epoch+1, psnr_val))
...
if __name__ == "__main__":
	parser = argparse.ArgumentParser(description="FEUNet")
